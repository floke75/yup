...
- **Rive→NDI on Windows:** Follow the [pipeline overview](./docs/rive_ndi_overview.md) to configure the Windows-only offscreen renderer, Python bindings, and upcoming NDI tooling.
